...
import com.cn.shool.bigdata.bigdata.common.adjuster.StringAdjuster;
...
public class HdfsAdmin {
    ...
    private static final String HDFS_SITE = "test/spark/hive/hdfs-site.xml";
    private static final String CORE_SITE = "test/spark/hive/core-site.xml";
    ...
    private HdfsAdmin(Configuration conf, Logger logger){
        try {
            ...
            conf.set("fs.defaultFS","hdfs://hadoop-11:8020");
